// =======================================================================================
// CustomCargo.h : The custom cargo DLL interface.
...
DLLCLBK void DeleteCustomCargo(UCSO::CustomCargo* cargo);

DLLCLBK UCSO::CustomCargo* GetCustomCargo(OBJHANDLE handle);